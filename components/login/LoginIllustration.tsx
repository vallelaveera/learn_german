...
export function LoginIllustration() {
  ...
  `}</style>
      ...
      <g className="maya-g">
        ...
        <circle cx="88" cy="58" r="28" fill="#534AB7" />
        <path d="M62 58 Q88 38 114 58" fill="#534AB7" />
        <path d="M60 72 Q88 55 116 72" fill="#534AB7" opacity=".5" />
        ...
        <rect x="68" y="104" width="40" height="50" rx="10" fill="#7F77DD" />
        <rect x="60" y="114" width="14" height="32" rx="7" fill="#7F77DD" />
        <rect x="106" y="114" width="14" height="32" rx="7" fill="#7F77DD" />
        <rect x="63" y="116" width="10" height="20" rx="5" fill="#534AB7" />
        <rect x="109" y="116" width="10" height="20" rx="5" fill="#534AB7" />
        <rect x="74" y="150" width="14" height="28" rx="7" fill="#534AB7" />
        <rect x="90" y="150" width="14" height="28" rx="7" fill="#534AB7" />
        <rect x="74" y="168" width="14" height="12" rx="4" fill="#3C3489" />
        <rect x="90" y="168" width="14" height="12" rx="4" fill="#3C3489" />
        <text
          x="88"
          y="30"
          textAnchor="middle"
      ...
      <g className="user-g">
        ...
        <path d="M206 65 Q232 45 258 65" fill="#2C2C2A" />
      ...
      <g className="floatde">
        <rect x="18" y="50" width="56" height="22" rx="8" fill="#534AB7" opacity=".9" />
        <text
          x="46"
          y="65"
          textAnchor="middle"
