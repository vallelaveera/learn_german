          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                ...
                <span style={{ fontSize: 10, background: "var(--accent-glow)", color: "var(--accent)", border: "0.5px solid var(--accent-dim)", padding: "1px 6px", borderRadius: 4, letterSpacing: "0.06em" }}>HANDS FREE</span>
              </div>
